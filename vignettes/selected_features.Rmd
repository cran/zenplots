...
Note that sections are numbered (or omitted) accordingly. Furthermore, it is
...
useful for laying out 2d plots which are not necessarily connected through a variable; note
that in this case, one would typically also show different 1d plots as the labeling is rather
confusing):
...
This method considers two groups: One of size three, the other of size five.
...
```{r, fig.align = "center", fig.width = 8, fig.height = 7.2}
